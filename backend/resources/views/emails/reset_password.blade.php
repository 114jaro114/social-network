                                                          ...
                                                          <tr>
                                                            <td>
                                                              <table width="170" cellspacing="0" cellpadding="0" border="0" align="center">
                                                                <tbody>
                                                                  <tr>
                                                                    <td><a href="#" style="text-decoration:none;"><img src="{{ asset('images/default.png') }}" style="width: 350px;" /></a></multiline></td>
                                                                  </tr>
                                                                </tbody>
                                                              </table>
                                                            </td>
                                                            ...
                                                            <tr>
                                                                <td style="font-family:'Open Sans', sans-serif, Verdana; font-size:20px; color:#3b3a3a; font-weight:bold; line-height:50px; text-transform:none;" mc:edit="fm-40" valign="top" align="center">
                                                                    <multiline>Požiadavka na resetovanie hesla</multiline>
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                            ...
                                                            <tr>
                                                                <td style="font-family:'Open Sans', sans-serif, Verdana; font-size:14px; color:#3b3a3a; font-weight:normal; line-height:24px;" mc:edit="fm-41" valign="top" align="left">
                                                                    <strong>Ahoj {{ ucfirst($name) }},</strong>
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                <td style="font-family:'Open Sans', sans-serif, Verdana; font-size:14px; color:#3b3a3a; font-weight:normal; line-height:24px;" mc:edit="fm-41" valign="top" align="left">
                                                                    <multiline>Dostali sme žiadosť o obnovenie hesla. Ak si žiadosť neodoslal, jednoducho tento e-mail ignoruj. V opačnom prípade môžeľ heslo obnoviť pomocou nasledujúceho linku:</multiline>
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                            ...
                                                            <tr>
                                                              <td>
                                                                <table  style="font-family:'Open Sans', sans-serif, Verdana; font-size:14px; color:#3b3a3a; font-weight:normal; line-height:24px;">
                                                                  <tr>
                                                                    <td>
                                                                      <a href="{!! $link !!}" class="btn btn-xs btn-info pull-right">Resetovať heslo</a>
                                                            ...
                                                            <tr>
                                                                <td>
                                                                  <table  style="font-family:'Open Sans', sans-serif, Verdana; font-size:14px; color:#3b3a3a; font-weight:normal; line-height:24px;">
                                                                    <tr>
                                                                      <td>S pozdravom, <br> Tím Beseduj.sk</td>
                                                                    </tr>
                                                                  </table>
                                                                </td>
                                                              </tr>
