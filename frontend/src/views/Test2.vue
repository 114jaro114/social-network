...
<v-container class="test2 pt-16">
  ...
  <template v-for="(post_data, post_index) in $root.navigationDrawerCenter.getAllPosts.allPosts">
      ...
      <v-card class="mb-3 rounded" elevation="0">
        <v-list-item>
          <v-list-item-avatar>
            ...
            <v-avatar color="primary" size="40" v-else>
              <v-img :lazy-src="`http://127.0.0.1:8000/storage/user-avatar/${post_data.userpostmodel.avatar}`" :src="`http://127.0.0.1:8000/storage/user-avatar/${post_data.userpostmodel.avatar}`" />
            </v-avatar>
          </v-list-item-avatar>
          ...
          <v-list-item-content>
            <v-list-item-title class="d-flex justify-start">
              <v-tooltip bottom>
                ...
                <span v-if="post_data.userpostmodel.name == $root.me.name">
            ...
            <v-list-item-subtitle class="d-flex justify-start primary--text">
              <v-tooltip bottom>
                ...
                <span>
                  <v-icon left class="mr-1" small color="white">mdi-clock-outline</v-icon>{{post_data.created_at}}
                </span>
              </v-tooltip>
          ...
          <v-list-item-action>
            <v-menu left>
              ...
              <v-list>
                <v-list-item-group color="primary" v-if=" post_data.userpostmodel.name == $root.me.name">
                  <v-list-item>
        ...
        <v-list-item class="p-0" v-if="post_data.image_url != null">
          <v-list-item-content class="p-0">
            <v-img :lazy-src="`http://127.0.0.1:8000/storage/post_img_video/${post_data.image_url}`" :src="`http://127.0.0.1:8000/storage/post_img_video/${post_data.image_url}`" />
          </v-list-item-content>
        </v-list-item>
          ...
          <v-list-item-content class="p-0">
            <vue-plyr>
              <video controls playsinline>
                ...
                <source size="1080" :src="'http://127.0.0.1:8000/storage/post_img_video/' +  post_data.video_url" type="video/mp4">
                      ...
                      <v-tabs v-model="tabReactionsPost[post_data.id]" background-color="primary white--text" dark :show-arrows="true">
                        ...
                        <v-tab class="h-100" v-if="post_data.like != 0">
                          <v-img max-height="20" max-width="20" lazy-src="https://emojipedia-us.s3.dualstack.us-west-1.amazonaws.com/thumbs/160/facebook/65/thumbs-up-sign_1f44d.png"
                            src="https://emojipedia-us.s3.dualstack.us-west-1.amazonaws.com/thumbs/160/facebook/65/thumbs-up-sign_1f44d.png" />
                          <span class="ml-1">{{post_data.like}}</span>
                        </v-tab>
                        ...
                        <v-tab class="h-100" v-if="post_data.heart != 0">
                          <v-img max-height="20" max-width="20" lazy-src="https://emojipedia-us.s3.dualstack.us-west-1.amazonaws.com/thumbs/160/facebook/65/heavy-black-heart_2764.png"
                            src="https://emojipedia-us.s3.dualstack.us-west-1.amazonaws.com/thumbs/160/facebook/65/heavy-black-heart_2764.png" />
                          <span class="ml-1">{{post_data.heart}}</span>
                        </v-tab>
                        ...
                        <v-tab class="h-100" v-if="post_data.funny != 0">
                          <v-img max-height="20" max-width="20" lazy-src="https://emojipedia-us.s3.dualstack.us-west-1.amazonaws.com/thumbs/160/facebook/65/smiling-face-with-open-mouth-and-smiling-eyes_1f604.png"
                            src="https://emojipedia-us.s3.dualstack.us-west-1.amazonaws.com/thumbs/160/facebook/65/smiling-face-with-open-mouth-and-smiling-eyes_1f604.png" />
                          <span class="ml-1">{{post_data.funny}}</span>
                        </v-tab>
                        ...
                        <v-tab class="h-100" v-if="post_data.surprise != 0">
                          <v-img max-height="20" max-width="20" lazy-src="https://emojipedia-us.s3.dualstack.us-west-1.amazonaws.com/thumbs/160/facebook/65/face-with-open-mouth_1f62e.png"
                            src="https://emojipedia-us.s3.dualstack.us-west-1.amazonaws.com/thumbs/160/facebook/65/face-with-open-mouth_1f62e.png" />
                          <span class="ml-1">{{post_data.surprise}}</span>
                        </v-tab>
                        ...
                        <v-tab class="h-100" v-if="post_data.sad != 0">
                          <v-img max-height="20" max-width="20" lazy-src="https://emojipedia-us.s3.dualstack.us-west-1.amazonaws.com/thumbs/160/facebook/65/disappointed-but-relieved-face_1f625.png"
                            src="https://emojipedia-us.s3.dualstack.us-west-1.amazonaws.com/thumbs/160/facebook/65/disappointed-but-relieved-face_1f625.png" />
                          <span class="ml-1">{{post_data.sad}}</span>
                        </v-tab>
                        ...
                        <v-tab class="h-100" v-if="post_data.angry != 0">
                          <v-img max-height="20" max-width="20" lazy-src="https://emojipedia-us.s3.dualstack.us-west-1.amazonaws.com/thumbs/160/facebook/65/pouting-face_1f621.png"
                            src="https://emojipedia-us.s3.dualstack.us-west-1.amazonaws.com/thumbs/160/facebook/65/pouting-face_1f621.png" />
                          <span class="ml-1">{{post_data.angry}}</span>
                        </v-tab>
                      </v-tabs>
                      <v-spacer />
                            ...
                            <v-list-item-group v-model="reactionsPostAll" color="primary" v-for="(item, index) in post_data.postreactionmodel" :key="'all'+index">
                              <v-list-item v-if="post_data.id == item.post_id">
                                <v-badge bottom bordered :icon="getIcon(item.reaction_type)" offset-x="15" offset-y="15" class="mr-2">
                                  ...
                                  <v-avatar color="primary" size="40" v-else>
                                    <v-img :lazy-src="`http://127.0.0.1:8000/storage/user-avatar/${item.userpostreactionmodel.avatar}`" :src="`http://127.0.0.1:8000/storage/user-avatar/${item.userpostreactionmodel.avatar}`" />
                                  </v-avatar>
                                </v-badge>
                                <v-list-item-content>
            ...
            <v-flex class="text-right">
              <v-layout wrap justify-end>
                <div class="font-weight-bold">
                  <v-btn text class="pl-2 pr-2" disabled v-if="post_data.count_comments == 0">
                    {{post_data.count_comments}} Komentáre
                    <v-icon class="ml-2" small>mdi-chevron-up</v-icon>
                  </v-btn>

                  <v-btn text @click="handleSelected(post_data.id)" :key="post_data.id" class="pl-2 pr-2" v-else>
                    ...
                    <v-icon class="ml-2" style="display:none" :id="`showPostDetailsArrowDown${post_data.id}`" small>mdi-chevron-down</v-icon>
                    <v-icon class="ml-2" style="display:block" :id="`showPostDetailsArrowUp${post_data.id}`" small>mdi-chevron-up</v-icon>
                  </v-btn>

                  <v-dialog v-model="dialogPostShares[post_data.id]" max-width="600" :retain-focus="false">
                    <template v-slot:activator="{ on, attrs }">
                      <v-btn text class="pl-2 pr-2" v-bind="attrs" v-on="on" disabled v-if="post_data.count_shares == 0">
                        ...
                        <v-list-item-group color="primary" v-for="(item, index) in post_data.postsharemodel" :key="'shares'+index">
                          <v-list-item v-if="post_data.id == item.post_id">
                            <v-list-item-avatar>
                              ...
                              <v-avatar color="primary" size="40" v-else>
                                <v-img :lazy-src="`http://127.0.0.1:8000/storage/user-avatar/${item.userpostsharemodel.avatar}`" :src="`http://127.0.0.1:8000/storage/user-avatar/${item.userpostsharemodel.avatar}`" />
                              </v-avatar>
                            </v-list-item-avatar>
        ...
        <v-container style="display:none" :id="`showPostDetails${post_data.id}`" class="p-0">
            ...
            <v-list-item-content class="text-field-comment">
              ...
              <v-text-field @focus="focusedPostComment(post_data.id)" :hide-details="true" :ref="`commentInput${post_data.id}`" filled rounded dense clearable clear-icon="mdi-close" label="Koment" v-model="textNewPostComment[post_data.id]"
                ...
                <template slot="append">
                  <v-menu :close-on-content-click="false" v-model="autoselectMenuPost[post_data.id]" offset-y :position-y="60">
                    <template v-slot:activator="{ on, attrs }">
                      <v-icon class="mr-2" v-bind="attrs" v-on="on" @click="setEmojiID(post_data.id)">
                        mdi-emoticon
                      </v-icon>
                    </template>
          ...
          <v-list dense>
            <template v-for="(post_comment_data, index) in post_data.postcommentmodel">
              <v-container class="pt-0" append-icon="" v-if="post_data.id == post_comment_data.post_id" :key="'comments'+index">
                <v-list-item class="w-100 ">
                  <v-list-item-avatar class="ml-0">
                    ...
                    <v-avatar color="primary" size="40" v-else>
                      <v-img :lazy-src="`http://127.0.0.1:8000/storage/user-avatar/${post_comment_data.userpostcommentmodel.avatar}`" :src="`http://127.0.0.1:8000/storage/user-avatar/${post_comment_data.userpostcommentmodel.avatar}`" />
                    </v-avatar>
                  </v-list-item-avatar>
                  <v-list-item-content>
                    <v-card class="p-2 rounded-lg card-comments" elevation="0">
                      ...
                      <v-list-item-subtitle class="text-left primary--text font-weight-bold p-0 pl-1 pt-1">{{post_comment_data.text}}</v-list-item-subtitle>
                      <v-list-item-subtitle class="text-left p-0 pl-1">
                        <span>
                          ...
                          <v-tooltip bottom v-if="Math.round((new Date().getTime() - new Date(post_comment_data.created_at).getTime()) / 60000) < 60">
                            ...
                            <span>
                              <v-icon class="mr-1" small color="white">mdi-clock</v-icon>{{post_comment_data.created_at.toLocaleString()}}
                            </span>
                          </v-tooltip>
                        ...
                        <v-dialog max-width="600" :retain-focus="false" v-if="post_comment_data.count_reactions != 0">
                          <template v-slot:activator="{ on, attrs }">
                            <v-btn small text outlined class="hidden-sm-and-down primary--color rounded-pill" v-bind="attrs" v-on="on">
                              ...
                              <div class="primary--color">{{post_comment_data.count_reactions}}</div>
                            </v-btn>
                              ...
                              <v-toolbar color="primary" dark v-if="selectedDialogReactionsComment == null">
                                <v-tabs v-model="tabReactionsComment[post_comment_data.id]" background-color="primary white--text" dark :show-arrows="true">
                                  ...
                                  <v-tab class="h-100" v-if="post_comment_data.like != 0">
                                    <v-img max-height="20" max-width="20" lazy-src="https://emojipedia-us.s3.dualstack.us-west-1.amazonaws.com/thumbs/160/facebook/65/thumbs-up-sign_1f44d.png"
                                      src="https://emojipedia-us.s3.dualstack.us-west-1.amazonaws.com/thumbs/160/facebook/65/thumbs-up-sign_1f44d.png" />
                                    <span class="ml-1">{{post_comment_data.like}}</span>
                                  </v-tab>

                                  <v-tab class="h-100" v-if="post_comment_data.heart != 0">
                                    <v-img max-height="20" max-width="20" lazy-src="https://emojipedia-us.s3.dualstack.us-west-1.amazonaws.com/thumbs/160/facebook/65/heavy-black-heart_2764.png"
                                      src="https://emojipedia-us.s3.dualstack.us-west-1.amazonaws.com/thumbs/160/facebook/65/heavy-black-heart_2764.png" />
                                    <span class="ml-1">{{post_comment_data.heart}}</span>
                                  </v-tab>

                                  <v-tab class="h-100" v-if="post_comment_data.funny != 0">
                                    <v-img max-height="20" max-width="20" lazy-src="https://emojipedia-us.s3.dualstack.us-west-1.amazonaws.com/thumbs/160/facebook/65/smiling-face-with-open-mouth-and-smiling-eyes_1f604.png"
                                      src="https://emojipedia-us.s3.dualstack.us-west-1.amazonaws.com/thumbs/160/facebook/65/smiling-face-with-open-mouth-and-smiling-eyes_1f604.png" />
                                    <span class="ml-1">{{post_comment_data.funny}}</span>
                                  </v-tab>

                                  <v-tab class="h-100" v-if="post_comment_data.surprise != 0">
                                    <v-img max-height="20" max-width="20" lazy-src="https://emojipedia-us.s3.dualstack.us-west-1.amazonaws.com/thumbs/160/facebook/65/face-with-open-mouth_1f62e.png"
                                      src="https://emojipedia-us.s3.dualstack.us-west-1.amazonaws.com/thumbs/160/facebook/65/face-with-open-mouth_1f62e.png" />
                                    <span class="ml-1">{{post_comment_data.surprise}}</span>
                                  </v-tab>

                                  <v-tab class="h-100" v-if="post_comment_data.sad != 0">
                                    <v-img max-height="20" max-width="20" lazy-src="https://emojipedia-us.s3.dualstack.us-west-1.amazonaws.com/thumbs/160/facebook/65/disappointed-but-relieved-face_1f625.png"
                                      src="https://emojipedia-us.s3.dualstack.us-west-1.amazonaws.com/thumbs/160/facebook/65/disappointed-but-relieved-face_1f625.png" />
                                    <span class="ml-1">{{post_comment_data.sad}}</span>
                                  </v-tab>

                                  <v-tab class="h-100" v-if="post_comment_data.angry != 0">
                                    <v-img max-height="20" max-width="20" lazy-src="https://emojipedia-us.s3.dualstack.us-west-1.amazonaws.com/thumbs/160/facebook/65/pouting-face_1f621.png"
                                      src="https://emojipedia-us.s3.dualstack.us-west-1.amazonaws.com/thumbs/160/facebook/65/pouting-face_1f621.png" />
                                    <span class="ml-1">{{post_comment_data.angry}}</span>
                                  </v-tab>
                                </v-tabs>
                                      ...
                                      <v-list-item-group v-model="reactionsCommentAll" color="primary" v-for="(item, index) in post_comment_data.commentreactionmodel2" :key="'all'+index">
                                        <v-list-item v-if="post_comment_data.id == item.comment_id">
                                          <v-badge bottom bordered :icon="getIcon(item.reaction_type)" offset-x="15" offset-y="15" class="mr-2">
                                            ...
                                            <v-avatar color="primary" size="40" v-else>
                                              <v-img :lazy-src="`http://127.0.0.1:8000/storage/user-avatar/${item.usercommentreactionmodel.avatar}`" :src="`http://127.0.0.1:8000/storage/user-avatar/${item.usercommentreactionmodel.avatar}`" />
                                            </v-avatar>
                                          </v-badge>
                                          <v-list-item-content>
                    ...
                    <v-row class="ml-0 mr-0 mt-0">
                      <v-btn @click="show_comments(post_comment_data.id)" v-if="post_comment_data.count_comments == 1" text small class="d-flex justify-start caption primary--text font-weight-bold"
                        v-bind:class="'btn_answers_on_comments' + post_comment_data.id">
                        <v-icon class="" color="primary" size="20">mdi-alpha-l</v-icon>
                        {{post_comment_data.count_comments}} Odpoveď
                        <v-icon class="ml-2" style="display:none" v-bind:class="'btn_answers_on_comments_arrow_down' + post_comment_data.id" small>mdi-chevron-down</v-icon>
                        <v-icon class="ml-2" style="display:block" v-bind:class="'btn_answers_on_comments_arrow_up' + post_comment_data.id" small>mdi-chevron-up</v-icon>
                      </v-btn>
                      <v-btn @click="show_comments(post_comment_data.id)" v-if="post_comment_data.count_comments > 1" text small class="d-flex justify-start caption primary--text font-weight-bold"
                        v-bind:class="'btn_answers_on_comments' + post_comment_data.id">
                        <v-icon class="" color="primary" size="20">mdi-alpha-l</v-icon>
                ...
                <template v-for="(answer_on_comment_data, index) in post_comment_data.answeroncommentmodel">
                  <div v-bind:class="'answers_on_comments' + post_comment_data.id" style="display:none" :key="index">
                    <v-list-item v-if="post_comment_data.id == answer_on_comment_data.comment_id" class="ml-16">
                      <v-list-item-avatar class="ml-0 mr-2">
                        ...
                        <v-avatar color="primary" size="28" v-else>
                          <v-img :lazy-src="`http://127.0.0.1:8000/storage/user-avatar/${answer_on_comment_data.useransweroncommentmodel.avatar}`"
                            :src="`http://127.0.0.1:8000/storage/user-avatar/${answer_on_comment_data.useransweroncommentmodel.avatar}`" />
                        </v-avatar>
                      </v-list-item-avatar>
                      <v-list-item-content>
                        <v-card class="p-2 rounded-lg card-comments" elevation="0" color="#f5f5f5">
                          ...
                          <v-list-item-subtitle class="text-left primary--text font-weight-bold p-0 pl-1 pt-1">{{answer_on_comment_data.text}}</v-list-item-subtitle>
                          <v-list-item-subtitle class="text-left p-0 pl-1">
                            <span>
                              <!-- minutes -->
                              <v-tooltip bottom v-if="Math.round((new Date().getTime() - new Date(answer_on_comment_data.created_at).getTime()) / 60000) < 60">
                                ...
                                <span>
                                  <v-icon class="mr-1" small color="white">mdi-clock</v-icon>{{answer_on_comment_data.created_at.toLocaleString()}}
                                </span>
                              </v-tooltip>
                            ...
                            <v-dialog max-width="600" :retain-focus="false" v-if="answer_on_comment_data.count_reactions != 0">
                              <template v-slot:activator="{ on, attrs }">
                                <v-btn small text outlined class="hidden-sm-and-down primary--color rounded-pill" v-bind="attrs" v-on="on">
                                  ...
                                  <div class="primary--color">{{answer_on_comment_data.count_reactions}}</div>
                                </v-btn>
                                <v-btn text outlined class="hidden-md-and-up primary--color rounded-pill" :min-width="40" v-bind="attrs" v-on="on">
                                  <div class="">
                                    <v-menu open-on-hover bottom offset-y v-if="answer_on_comment_data.like != 0">
                                  ...
                                  <v-toolbar color="primary" dark v-if="selectedDialogReactionsAnswerOnComment == null">
                                    <v-tabs v-model="tabReactionsAnswerOnComment[answer_on_comment_data.id]" background-color="primary white--text" dark :show-arrows="true">
                                      ...
                                      <v-tab class="h-100" v-if="answer_on_comment_data.like != 0">
                                        <v-img max-height="20" max-width="20" lazy-src="https://emojipedia-us.s3.dualstack.us-west-1.amazonaws.com/thumbs/160/facebook/65/thumbs-up-sign_1f44d.png"
                                          src="https://emojipedia-us.s3.dualstack.us-west-1.amazonaws.com/thumbs/160/facebook/65/thumbs-up-sign_1f44d.png" />
                                        <span class="ml-1">{{answer_on_comment_data.like}}</span>
                                      </v-tab>

                                      <v-tab class="h-100" v-if="answer_on_comment_data.heart != 0">
                                        <v-img max-height="20" max-width="20" lazy-src="https://emojipedia-us.s3.dualstack.us-west-1.amazonaws.com/thumbs/160/facebook/65/heavy-black-heart_2764.png"
                                          src="https://emojipedia-us.s3.dualstack.us-west-1.amazonaws.com/thumbs/160/facebook/65/heavy-black-heart_2764.png" />
                                        <span class="ml-1">{{answer_on_comment_data.heart}}</span>
                                      </v-tab>

                                      <v-tab class="h-100" v-if="answer_on_comment_data.funny != 0">
                                        <v-img max-height="20" max-width="20" lazy-src="https://emojipedia-us.s3.dualstack.us-west-1.amazonaws.com/thumbs/160/facebook/65/smiling-face-with-open-mouth-and-smiling-eyes_1f604.png"
                                          src="https://emojipedia-us.s3.dualstack.us-west-1.amazonaws.com/thumbs/160/facebook/65/smiling-face-with-open-mouth-and-smiling-eyes_1f604.png" />
                                        <span class="ml-1">{{answer_on_comment_data.funny}}</span>
                                      </v-tab>

                                      <v-tab class="h-100" v-if="answer_on_comment_data.surprise != 0">
                                        <v-img max-height="20" max-width="20" lazy-src="https://emojipedia-us.s3.dualstack.us-west-1.amazonaws.com/thumbs/160/facebook/65/face-with-open-mouth_1f62e.png"
                                          src="https://emojipedia-us.s3.dualstack.us-west-1.amazonaws.com/thumbs/160/facebook/65/face-with-open-mouth_1f62e.png" />
                                        <span class="ml-1">{{answer_on_comment_data.surprise}}</span>
                                      </v-tab>

                                      <v-tab class="h-100" v-if="answer_on_comment_data.sad != 0">
                                        <v-img max-height="20" max-width="20" lazy-src="https://emojipedia-us.s3.dualstack.us-west-1.amazonaws.com/thumbs/160/facebook/65/disappointed-but-relieved-face_1f625.png"
                                          src="https://emojipedia-us.s3.dualstack.us-west-1.amazonaws.com/thumbs/160/facebook/65/disappointed-but-relieved-face_1f625.png" />
                                        <span class="ml-1">{{answer_on_comment_data.sad}}</span>
                                      </v-tab>

                                      <v-tab class="h-100" v-if="answer_on_comment_data.angry != 0">
                                        <v-img max-height="20" max-width="20" lazy-src="https://emojipedia-us.s3.dualstack.us-west-1.amazonaws.com/thumbs/160/facebook/65/pouting-face_1f621.png"
                                          src="https://emojipedia-us.s3.dualstack.us-west-1.amazonaws.com/thumbs/160/facebook/65/pouting-face_1f621.png" />
                                        <span class="ml-1">{{answer_on_comment_data.angry}}</span>
                                      </v-tab>
                                    </v-tabs>
                ...
                <!-- odpoved na post -->
                <v-container :id="`itemsPostComment${post_comment_data.id}`" class="pr-0 pl-0 pt-0" style="display:none">
                  ...
                  <v-list-item class="ml-16">
                    ...
                    <v-list-item-content>
                      ...
                      <!-- <template v-slot:activator="{ on }"> -->
                      <!-- v-on="on"  -->
                      <v-text-field @focus="focusedAnswerOnComment(post_comment_data.id)" :hide-details="true" ref="commentInputChild" filled rounded dense clearable clear-icon="mdi-close" label="Koment" v-model="textNewAnswerOnComment"
                        @click:clear="clearAnswerOnComment(post_comment_data.id)" @keydown.enter="answerOnComment(post_comment_data.id)">
...
export default {
  ...
  methods: {
    ...
    clearAnswerOnComment() {
      ...
      this.itemsPostComment = false;
      for (var x = 0; x < this.$root.navigationDrawerCenter.getAllPosts.allPosts.length; x++) {
        for (var y = 0; y < this.$root.navigationDrawerCenter.getAllPosts.allPosts[x].postcommentmodel.length; y++) {
          document.getElementById(`itemsPostComment${this.$root.navigationDrawerCenter.getAllPosts.allPosts[x].postcommentmodel[y].id}`).style.display = 'none';
          for (var z = 0; z < this.$root.navigationDrawerCenter.getAllPosts.allPosts[x].postcommentmodel[y].answeroncommentmodel.length; z++) {
            document.getElementById(`itemsPostComment${this.$root.navigationDrawerCenter.getAllPosts.allPosts[x].postcommentmodel[y].answeroncommentmodel[z].comment_id}`).style.display = 'none';
          }
        }
      }
    },
      ...
      if (item.answeroncommentmodel != undefined) {
        if (document.getElementById(`itemsPostComment${item.id}`).style != null) {
          ...
          if (document.getElementById(`itemsPostComment${item.id}`).style.display == 'none') {
            ...
            this.chipTextAnswerOnComment = item.userpostcommentmodel.name + ' ';
            this.textNewAnswerOnComment = '';
            this.$nextTick(() => this.$refs.commentInputChild[0].focus());
            this.showDialogFriendsAnswerOnComment = false;
        ...
        if (document.getElementById(`itemsPostComment${item.comment_id}`).style != null) {
          ...
          if (document.getElementById(`itemsPostComment${item.comment_id}`).style.display == 'none') {
            ...
            this.chipTextAnswerOnComment = item.useransweroncommentmodel.name + ' ';
            this.textNewAnswerOnComment = '';
            this.$nextTick(() => this.$refs.commentInputChild[0].focus());
            this.showDialogFriendsAnswerOnComment = false;
            this.$refs.commentInputChild[0].focus();
    ...
    show_comments(post_comment_data_id) {
      ...
      for (var i = 0; i < length; i++) {
        if (document.getElementsByClassName("answers_on_comments" + post_comment_data_id)[i].style.display == 'none') {
          ...
          document.getElementsByClassName("answers_on_comments" + post_comment_data_id)[i].style.display = 'none';
