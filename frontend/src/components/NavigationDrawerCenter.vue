<template id="NavigationDrawerCenter">
<v-container class="center">
  ...
  <v-row class="p-3" align="center" v-if="((this.$root.navigationDrawerCenter.getAllPosts.countActualPosts == this.$root.navigationDrawerCenter.getAllPosts.countAllPosts)
                                          || (this.$root.navigationDrawerCenter.getAllPosts.countActualPosts < this.$root.navigationDrawerCenter.getAllPosts.countAllPosts))
                                          && this.$root.navigationDrawerCenter.getAllPosts.countActualPosts != 0 && this.$root.navigationDrawerCenter.getAllPosts.countAllPosts != 0
                                          && this.$root.navigationDrawerCenter.getAllPosts.loadingPosts == false">
    <v-divider />
    <v-btn class="ml-3 mr-3" small rounded text outlined color="primary" disabled>Všetko</v-btn>
    <v-divider />
  </v-row>

  <v-row class="p-3" align="center" v-else-if="this.$root.navigationDrawerCenter.getAllPosts.countActualPosts == 0 && this.$root.navigationDrawerCenter.getAllPosts.countAllPosts == 0 && this.$root.navigationDrawerCenter.getAllPosts.loadingPosts == false">
    <v-divider />
    <v-btn class="ml-3 mr-3" small rounded text outlined color="primary" disabled>Žiadne príspevky</v-btn>
    <v-divider />
  </v-row>

  <scroll-loader :loader-method="scrollLoaderGetAllPosts" :loader-disable="$root.navigationDrawerCenter.getAllPosts.loadingPaginate" v-else>
      <v-progress-circular v-if="!$root.navigationDrawerCenter.getAllPosts.loadingPaginate" indeterminate size="24" color="primary"></v-progress-circular>
  </scroll-loader>
  </v-container>
  </template>
  ...
  export default {
    ...
    data() {
      return {
        ...
        page: this.$root.navigationDrawerCenter.getAllPosts.countActualPosts,
        pageSize: 3,
    ...
    methods: {
      ...
      scrollLoaderGetAllPosts() {
        ...
        const api = `${process.env.VUE_APP_API_URL}/getAllDataAboutPosts/${this.$root.navigationDrawerCenter.getAllPosts.countActualPosts}/${this.pageSize}`;
        const config = {
          headers: {
        ...
        axios.get(api, config)
          .then(res => {
            if (res.data[0].length != 0) {
              this.$root.navigationDrawerCenter.getAllPosts.countActualPosts += res.data[0].length;
              this.$root.navigationDrawerCenter.getAllPosts.allPosts = [...this.$root.navigationDrawerCenter.getAllPosts.allPosts, ...res.data[0]]
            }
    ...
    watch: {
      ...
      page (value) {
        this.$root.navigationDrawerCenter.getAllPosts.loadingPaginate = value > this.$root.navigationDrawerCenter.getAllPosts.countPosts
      }
    },
            ...
            if (elem.id == e.allDataPost[0].id) {
              if (e.dataType == 'addPostComment' || e.dataType == 'addAnswerOnComment') {
                ...
                // if (e.dataType == 'addAnswerOnComment') {
                  // this.$root.navigationDrawerCenter.getAllPosts.allPosts[index].postcommentmodel.forEach((elem2, index2) => {
                    // if (elem2.id == e.post_comment_id) {
                      // console.log("dnu");
                      // this.$root.navigationDrawerCenter.getAllPosts.allPosts[index].postcommentmodel[index2] = e.allDataPost[0].postcommentmodel[index2];
                  ...
                  // })
                // } else {
                //   this.$root.navigationDrawerCenter.getAllPosts.allPosts[index].postcommentmodel.push(e.allDataPost[0].postcommentmodel[e.post_comment_id-1]);
                // }
              }
            }
          })
